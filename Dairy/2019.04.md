...
1. 了解并实践了日常工作中经常使用的Git命令；

   https://www.liaoxuefeng.com/wiki/0013739516305929606dd18361248578c67b8067c8c017b000

2. 了解了docker-compose的基本使用方式；

3. 安装并大概了解了开发工具pycharm和datagrip的使用。

### 明日待办

1. 复习昨日所学的知识点（2h）；Done
2. Python编程规范（2h）；
3. Python基本语法（3h）；
...
1. 回顾昨日所学的Git，整理了部分命令；

2. 熟悉了Docker的基础概念和常用操作：
...
3. 跟着官方文档构建并运行了应用，使用docker-compose扩展应用：
